		...
		<div className="min-h-screen bg-[#0a0a1a] text-[#4c9eff] font-pip-boy cursor-pip-boy">
			...
			<section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
				...
				<div className="container relative z-10 px-4 py-20 text-center">
					...
					>
						The biggest hackathon by Microsoft Learners Student Chapter.
						Join us for an unforgettable coding experience and expand your
						tech horizons.
					</motion.p>
				...
				<div className="container relative z-10 mx-auto px-4">
					...
					>
						...
						<p className="max-w-2xl mx-auto text-[#4c9eff]/80 pixelated-text">
							Mark your calendar for these important dates. Be prepared
							for each phase of BlueBit.
						</p>
					</motion.div>
			...
			<section id="rules" className="py-20 bg-[#0f1a2a] relative">
				<div className="absolute inset-0 z-0 opacity-5">
					<Image
						src="/images/circuit-background.jpg"
				...
				<div className="container relative z-10 mx-auto px-4 text-center">
					<motion.div
						...
						className="mb-10"
					>
						<h2 className="text-4xl md:text-5xl font-bold mb-4 pip-boy-text pixelated-text">
							EVENT RULEBOOK
						</h2>
						<p className="max-w-2xl mx-auto text-[#4c9eff]/80 mb-10 pixelated-text">
							Make sure you understand all the rules before participating
							in BlueBit. View our comprehensive rulebook.
						</p>
					...
					<motion.div
						...
						className="mt-16"
					>
						<h3 className="text-2xl font-bold mb-6 pip-boy-text pixelated-text">
			...
			<footer className="bg-[#0a0a1a] border-t border-[#4c9eff]/30 py-10">
				<div className="container mx-auto px-4">
					<div className="grid grid-cols-1 md:grid-cols-3 gap-10">
						<div>
							...
							<p className="text-[#4c9eff]/70 pixelated-text">
								The biggest hackathon organized by Microsoft Learn
								Student Chapter. Join us for an unforgettable
								experience.
							</p>
						</div>
						...
						<div>
							...
							<div className="flex gap-4">
								<Link
									href="#"
									className="text-[#4c9eff] hover:text-[#a3d0ff] transition-colors"
								>
					...
					<div className="mt-10 pt-6 border-t border-[#4c9eff]/30 text-center text-[#4c9eff]/50 text-sm pixelated-text">
						&copy; {new Date().getFullYear()} BlueBit. All rights reserved.
						Microsoft Learners Student Chapter.
					</div>
				</div>
			</footer>
	...
	return (
		...
		>
			...
			<div className={cn("w-1/2 px-4", isLeft ? "text-left" : "text-right")}>
				<h3 className="text-2xl font-bold pip-boy-text mb-2 pixelated-text">
					{title}
				</h3>
...
const timelineEvents = [
	{
		...
		description:
			"Sign up for BlueBit and secure your spot in this exciting hackathon.",
	},
	{
		date: "MAR 17, 2025 at 6:00 PM",
		title: "Round 1: PPT Submission starts",
		description:
			"Problem statements will be released. 3 days will be provided to create and submit a PPT.",
	},
	{
	...
	},
	{
		...
		description:
			"The proposed solutions in the presentation have to be implemented in the given 36 hours.",
	},
	{
	...
	},
	{
		...
		description:
			"Complete project implementation is expected to be completed in this round.",
	},
	{
